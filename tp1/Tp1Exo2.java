    ...
    public static void main(String[] args) {
        ...
        */
        ...
        }
        {
            ...
            long b, c = 1L;
            a = 0;
            b = 2l;// Commentez cette ligne et interprétez l'erreur Java
            // quand on met b=2, 2 est de base un int, il faut alors spécifier que c'est un long en mettant l derrière
            print("a:" + a + " b:" + b + " c:" + c);
        }
        {
            short a = 257;
