...
<% String idDuMembre = request.getAttribute("id").toString(); %>
<% String nomDuMembre = request.getAttribute("nom").toString(); %>
<% String prenomDuMembre = request.getAttribute("prenom").toString(); %>
<% String adresseDuMembre = request.getAttribute("adresse").toString(); %>
<% String emailDuMembre = request.getAttribute("email").toString(); %>
<% String telephoneDuMembre = request.getAttribute("telephone").toString(); %>

<%! private EmpruntService empruntService = EmpruntServiceImpl.getInstance(); %>
<%! private List<Emprunt> emprunts = new ArrayList<>(); %>
<% emprunts = (List) empruntService.getListCurrentByMembre(idDuMembre); %>
